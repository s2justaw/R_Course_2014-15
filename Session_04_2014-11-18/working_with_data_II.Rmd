...
## Samples (für Stichprobenziehen gut geeignet)
```{r samples, echo=T}
set.seed(1)
...
* Durchschnittliche LÃ¤nge der Substantive in Buchstaben berechnen. #mit nchar()

* Den Dataframe anpassen und die Verteilung von Substantiven nach dem Genus berechnen.
mit rbind() und cbind() (Zeilen und Spalten zusammenfügen) und table()

* Anzahl der autosemantischen WÃ¶rtern im Text berechnen.
(autosemantika u sinsem)
